...
$res = $mysqli->query("SELECT * FROM genders ORDER BY name ASC");
$genders = $res ? $res->fetch_all(MYSQLI_ASSOC) : [];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Manage Genders - Admin</title>
...
<div class="main-content">
    <div class="admin-header">
        ...
        <p>Add and remove product genders</p>
    </div>

    <div class="form">
      <form method="post">
        <label>Add Gender</label>
        <input name="name" placeholder="e.g. Men, Women, Unisex" value="<?=htmlspecialchars($_POST['name'] ?? '')?>">
      ...
      <table class="table">
        ...
        <?php foreach ($genders as $g): ?>
          <tr>
            ...
            <td><a class="del" href="manage-genders.php?delete=<?= (int)$g['id'] ?>" onclick="return confirm('Delete?')">Delete</a></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
      </table>
